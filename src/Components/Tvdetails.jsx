...
import { asyncTvdetails, removeTv } from "../store/actions/tvActions";
  ...
  return value ? (
    <div className="h-[190vh] w-full relative bg-[#101010]">
      ...
      <div className="overimage h-full w-full px-0 lg:px-12 top-0 left-0 absolute z-[2]">
        <div className="nav px-4  h-24 text-white  text-3xl flex gap-20 items-center">
        ...
        <div className="details">
            ...
            <div className="moviedetails">
              ...
              <div className="otherdetail text-white text-lg pl-1 mt-2 flex gap-4 ">
                <div className="relasedate">
                  <h1>{value.details.first_air_date.split("-")[0]}</h1>
                </div>
              ...
              <div className="overview pt-3 text-white">
                ...
                <h1 className="text-xl pt-2 text-pretty w-[80%] leading-[1.2]">
          ...
          <div className="lowertolower mt-6 ">
            <h1 className="text-white px-12 text-3xl mb-6 ">Seasons</h1>

            <Similarmovie title={"tv"} data={value.details.seasons} />
          </div>
